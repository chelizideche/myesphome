...
uint8_t Sparkfun14Seg::send_to_display(i2c::I2CDevice *display, uint8_t position) {
  ...
  const std::unordered_map<char, uint16_t> char_map = {
      ...
      {'(', 0b0001100000000000}, {')', 0b0100001000000000}, {'*', 0b0011111101000000}, {'+', 0b0010010101000000},
      ...
      {'U', 0b0000000000111110}, {'V', 0b0100100000110000}, {'W', 0b0001000000110110}, {'X', 0b0001101000000000},
      ...
      {'u', 0b0000000000011100}, {'v', 0b0001000000000100}, {'w', 0b0001000000010100}, {'x', 0b0001000101000000},
...
uint8_t Sparkfun14SegFlip::send_to_display(i2c::I2CDevice *display, uint8_t position) {
  ...
  const std::unordered_map<char, uint16_t> char_map = {
      ...
      {'(', 0b0100001000000000}, {')', 0b0001100000000000}, {'*', 0b0111011101000000}, {'+', 0b0010010101000000},
      ...
      {'U', 0b0000000000110111}, {'V', 0b0100100000000110}, {'W', 0b0000001000110110}, {'X', 0b0101001000000000},
      ...
      {'u', 0b0000000000100011}, {'v', 0b0000001000100000}, {'w', 0b0000001000100010}, {'x', 0b0000001101000000},

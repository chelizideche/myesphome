...
from esphome.const import CONF_BRIGHTNESS, CONF_INVERT_COLORS, CONF_SWAP_XY
...
chip = DriverChip("RM67162", {CONF_BRIGHTNESS: 0xD0})
chip.cmd(PIXFMT, 0x55)
chip.cmd(BRIGHTNESS, 0)

chip = DriverChip("RM690B0", {CONF_BRIGHTNESS: 0xD0})
...
chip = DriverChip(
    "AXS15231", {CONF_DRAW_ROUNDING: 8, CONF_SWAP_XY: False, CONF_BRIGHTNESS: 0xD0}
)

...
class ClimateTraits {
 public:
  ...
  void add_supported_eco_mode(ClimateFanMode mode) { supported_fan_modes_.insert(mode); }
  ...
  void add_supported_pellet_mode(ClimateFanMode mode) { supported_fan_modes_.insert(mode); }

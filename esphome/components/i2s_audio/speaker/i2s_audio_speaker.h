...
class I2SAudioSpeaker : public I2SAudioOut, public speaker::Speaker, public Component {
 ...
 protected:
  ...
  /// @return ESP_ERR_INVALID_ARG if there is a parameter error, if there is more than 2 channels in the stream, or
  ///           if the audio settings are incompatible with the configuration.
